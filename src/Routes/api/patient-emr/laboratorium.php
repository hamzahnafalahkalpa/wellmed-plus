...
use Projects\Klinik\Controllers\API\PatientEmr\Laboratorium\{
...
Route::apiResource('/laboratorium',LaboratoriumController::class)->parameters(['laboratorium' => 'id']);
Route::group([
    "prefix" => "/laboratorium/{visit_registration_id}",
    "as"     => "laboratorium.show.",
],function() {
