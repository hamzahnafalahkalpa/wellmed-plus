...
use Projects\Klinik\Controllers\API\PatientEmr\VerlosKamer\{
...
Route::apiResource('/verlos-kamer',VerlosKamerController::class)->parameters(['verlos-kamer' => 'id']);
Route::group([
    "prefix" => "/verlos-kamer/{visit_registration_id}",
    "as"     => "verlos-kamer.show.",
],function() {
