...
use Projects\Klinik\Controllers\API\PatientEmr\Inpatient\{
...
Route::apiResource('/inpatient',InpatientController::class)->parameters(['inpatient' => 'id']);
Route::group([
    "prefix" => "/inpatient/{visit_registration_id}",
    "as"     => "inpatient.show.",
],function() {
