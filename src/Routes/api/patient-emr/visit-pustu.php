...
use Projects\Klinik\Controllers\API\PatientEmr\VisitPustu\{
...
Route::apiResource('/visit-pustu',VisitPustuController::class)->parameters(['visit-pustu' => 'id']);
Route::group([
    "prefix" => "/visit-pustu/{visit_registration_id}",
    "as"     => "visit-pustu.show.",
],function() {
