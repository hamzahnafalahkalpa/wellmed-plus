...
namespace Projects\Klinik\Controllers\API\PatientEmr\Inpatient;

use Projects\Klinik\Requests\API\PatientEmr\Inpatient\{
...
class InpatientController extends EnvironmentController
{
    ...
    public function store(StoreRequest $request){
        ...
        $medic_service = (!isset(request()->medic_service_id))
            ? $medic_service->where('label','RAWAT INAP')->firstOrFail()
